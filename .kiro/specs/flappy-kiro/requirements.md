...
**User Story:** ในฐานะผู้เล่น ฉันต้องการเห็นก้อนเมฆโปร่งแสงลอยผ่านพื้นหลังด้วยความเร็วต่างกัน เพื่อให้เกมมีบรรยากาศสวยงาม มีความลึก และมีชีวิตชีวา

#### เกณฑ์การยอมรับ (Acceptance Criteria)

1. THE Game_Engine SHALL เรนเดอร์ Cloud สีขาวมุมมนหลายก้อนบนพื้นหลังแบบ semi-transparent (โปร่งแสง) โดยใช้ค่า opacity ที่ต่ำกว่า 1.0
2. THE Game_Engine SHALL กำหนดความเร็วการเลื่อนของ Cloud แต่ละก้อนให้แตกต่างกัน เพื่อสร้างเอฟเฟกต์ perspective ที่ให้ความรู้สึกถึงความลึกของฉาก
3. THE Game_Engine SHALL เลื่อน Cloud ทุกก้อนจากขวาไปซ้ายด้วยความเร็วที่ช้ากว่า Pipe_Pair
4. THE Game_Engine SHALL กำหนด Cloud ที่เคลื่อนที่ช้ากว่าให้มีค่า opacity ต่ำกว่า Cloud ที่เคลื่อนที่เร็วกว่า เพื่อจำลองว่าอยู่ไกลออกไป
5. WHEN Cloud เลื่อนออกนอกขอบซ้ายของ Canvas, THE Game_Engine SHALL สร้าง Cloud ใหม่ที่ขอบขวาด้วยตำแหน่งแนวตั้งแบบสุ่มและความเร็วแบบสุ่ม
